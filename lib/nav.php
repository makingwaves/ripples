...
namespace MW\Ripples\Nav;

use MW\Ripples\Utils;
...
class SageNavWalker extends \Walker_Nav_Menu {
  ...
  function start_el(&$output, $item, $depth = 0, $args = [], $id = 0) {
    ...
    $item_html = apply_filters('ripples/wp_nav_menu_item', $item_html);
    $output .= $item_html;
  }
  ...
  public function cssClasses($classes, $item) {
    ...
    return array_filter($classes, 'MW\\Ripples\\Utils\\is_element_empty');
  }
}
